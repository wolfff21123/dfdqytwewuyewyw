...
app.listen(() => console.log("start self bot by fadigamer"));
...
const developers = "729313904597139466"//ايديك



///bot حاله

var statuss = ["هل تعلم ان الاثنين قبل الثلاثاء؟","Self bot by !HY ❋ ᖴᗩᗪI KOᖇO#2928"]; // بالإمكان اضافة المزيد بدون التعديل في الكود
var second  = 4; // عدد الثواني المحددة
client.on("ready", () =>{
  ...
  console.log(`ID ["${client.user.id}"]`);
    setInterval(function(){
        ...
        client.user.setActivity(statuss[num], {type: 'Streaming', url: 'https://twitch.tv/Fadi'})
    }, timeing)
});
...
client.on('message', msg => {  //WESO#0001
    if (msg.content === 'برب') {  //WESO#0001
      msg.reply('**تيت خذ راحتك بس لا تطول :heart:**');  //WESO#0001
    }
  });
  ...
  client.on('message', msg => {  //WESO#0001
   ...
   client.on('message', msg => {  //WESO#0001
    if (msg.content === 'هلا') {  //WESO#0001
     ...
     client.on('message', msg => {  //WESO#0001
    if (msg.content === 'هلا شباب') {  //WESO#0001
      msg.reply('**هلا يقلبي :hearts:**');  //WESO#0001
    }
  });

       client.on('message', msg => {  //WESO#0001
    if (msg.content === 'يا بوت انت ميت لو عايش ؟') {  //WESO#0001
      msg.reply('**لا انا ميت**');  //WESO#0001
    }
  });
...
var prefix = "!";
var cats = ["http://palestine-kitchen.ps/wp-content/uploads/2017/12/%D9%86%D9%83%D8%AA-%D8%AF%D8%A8%D8%A7%D9%86%D8%A9.png","http://www.i7lm.com/wp-content/uploads/2017/04/136769797816.jpg","https://4.bp.blogspot.com/-p62zmDIDXmI/WKzqNt9smaI/AAAAAAAAC4Q/sW_bSIB8OaQhwOYFeplc3uzz8PBN7l3YACEw/s1600/13602501135.jpg","https://www.universemagic.com/images/2016/03/7938-2-or-1457539273.jpg","https://1.bp.blogspot.com/-yFk-FzHSyE8/WR9fmPcsCUI/AAAAAAAAE6c/AmvjLadOiLY9GiCqMLHgA121bY2RS_dCwCLcB/s1600/%25D9%2586%25D9%2583%25D8%25AA%2B%25D9%2585%25D8%25B6%25D8%25AD%25D9%2583%25D8%25A9%2B1.jpg","https://l7zaat.com/wp-content/uploads/2018/02/423.jpg","https://www.petfinder.com/wp-content/uploads/2012/11/101438745-cat-conjunctivitis-causes.jpg","http://www.shuuf.com/shof/uploads/2018/02/08/jpg/shof_97d686082bdb0a2.jpg","https://up4net.com/uploads2/up4net--2.jpg","https://up4net.com/uploads2/up4net-2-435.jpg","https://up4net.com/uploads2/up4net-111-14.jpg","https://up4net.com/uploads2/up4net-1712.jpg","https://up4net.com/uploads2/up4net-unknown.png"];
...
**
『${prefix}say الكلام الي تبيه | البوت يكتبه بشكل جميل
『${prefix}ping | بمعرفة بنق البوت
『${prefix}hypixel | لعرض احصائياتك بهاي بكسل
『${prefix}binv | يجيب لك رابط اي بوت تمنشنه
『${prefix}savatar | عرض صورة السيرفر
『${prefix}report | لتبليغ على شخص
『${prefix}avatar | لعرض افتار الي تمنشنه
『${prefix}topinv | لمعرفة صاحب اعلى انفايتات 
『${prefix}Minv | لمعرفة عدد الانفايتات
**
`)
...
**
『${prefix}cr | لانشاء رتب الوان على حسب ما تريد
『${prefix}allbots | لمعرفة الوبتات الي بالسيرفر
『${prefix}count | لمعرفة عدد الاعضاء 
『${prefix}hide | لاخفاء الشات 
『${prefix}unhide | لاضهار الشات
『${prefix}lock | لقفل الشات 
『${prefix}unlock | لفتح الشات 
『${prefix}short | لاختصار اي رابط 
『${prefix}move | سحب العضو الى روم الصوتي
『${prefix}setnick | لتغير النيك نيم
...
『${prefix}mariam | لعبة مريم
『${prefix}sara7a | لعبة الصراحة
『${prefix}quas | اسالة عامة
『${prefix}cuttweet | كت تويت
『${prefix}kill | لعبة قتل
『${prefix}marry | لعبة زواج
『${prefix}نكت 
『${prefix}hack | لعبة تهكير
『${prefix}kiss | ما يحتاج اقول معناها هههه
`)
   message.author.sendEmbed(embed)
   message.reply('تم ارسالك بلخاص')
})
...
.setColor("RANDOM")
.setDescription(`${wolf.guild.name}`)
...
const cuttweet = [
     ...
     'كت تويت | كم عمرك لما عرفت ان الصقر مايموت لاكن ينتحر بسبب كثرة الامراض لما يكبر في عمرة؟',
     'كت تويت | كم عمرك لما عرفت العقرب لما تصير عليه دائرة من النار بيضل بيقرص نفسه لحد مايموت',
     'كت تويت | الحرية لـ ... ؟',
...
client.on('message', function(message) {
    if(message.content.startsWith(prefix + "report")) {
        ...
        if(!messageReason) return message.reply("**#  قم بادخال السبب !**");
    let mUser = message.mentions.users.first();
    if(!mUser) return message.channel.send("Couldn't find user.");
    let Rembed = new Discord.RichEmbed()
    .setTitle("`بلاغ جديد`")
    .setThumbnail(message.author.avatarURL)
    .addField("**# - المبلغ عليه :**",mUser,true)
    .addField("**# - اي دي المبلغ عليه:**",mUser.id,true)
    .addField("**# - السبب:**",messageReason,true)
    .addField("**# - الروم الذي تم ارسال البلاغ منه:**",message.channel,true)
